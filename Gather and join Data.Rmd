...
#Add Brückentag
#full_Dataset$Brueckentag <- 0
#for (date in unique(full_Dataset$Datum))
#  if (unique(full_Dataset$Hamburg.Feiertage[full_Dataset$Datum == date] == 1)) {
#    full_Dataset$Brueckentag[full_Dataset$Datum == date+1] <- 1
#  }
...
#Ausreißer fliegen auch! Ausreißer = alle Umsätze mit einer Abweichung > 3 SD
